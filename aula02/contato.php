    ...
    <main>
        ...
        <fieldset>
            <form action="envia.php" method="post">
                ...
                <input type="text" name="nome" id="" placeholder="Ex: Ana Silva" required><br>
                </div>

                <div id="assuntoEmail">
                <label>Informe o assunto</label><br>
                <input type="text" name="assunto" id="" placeholder="Ex: Olá" required><br>
                </div>
